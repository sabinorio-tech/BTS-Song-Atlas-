# Phase 2 Audio Similarity Research

## Objective

Phase 2 investigated whether BTS Song Atlas could add an independent audio recommendation engine without changing the existing lyric-based semantic atlas from Phase 1.
...
The Phase 2 branch was therefore framed as a technical feasibility investigation, not as a production implementation.
...
- [scripts/phase2/check_spotify_audio_features.py](/home/seans/becode/projects/BTS-Song-Atlas-/scripts/phase2/check_spotify_audio_features.py:1)
- supporting note: [docs/phase2/spotify_audio_feature_check.md](/home/seans/becode/projects/BTS-Song-Atlas-/docs/phase2/spotify_audio_feature_check.md:1)
...
Services considered in the Phase 2 research notes:
...
- [scripts/phase2/check_acousticbrainz.py](/home/seans/becode/projects/BTS-Song-Atlas-/scripts/phase2/check_acousticbrainz.py:1)
- [data/processed/phase2/acousticbrainz_coverage.csv](/home/seans/becode/projects/BTS-Song-Atlas-/data/processed/phase2/acousticbrainz_coverage.csv:1)
...
Phase 2 was converted from an implementation branch into a documented research branch.

Kept as supporting artifacts:

- [scripts/phase2/check_spotify_audio_features.py](/home/seans/becode/projects/BTS-Song-Atlas-/scripts/phase2/check_spotify_audio_features.py:1)
- [scripts/phase2/check_acousticbrainz.py](/home/seans/becode/projects/BTS-Song-Atlas-/scripts/phase2/check_acousticbrainz.py:1)
- [docs/phase2/spotify_audio_feature_check.md](/home/seans/becode/projects/BTS-Song-Atlas-/docs/phase2/spotify_audio_feature_check.md:1)
- [data/processed/phase2/acousticbrainz_coverage.csv](/home/seans/becode/projects/BTS-Song-Atlas-/data/processed/phase2/acousticbrainz_coverage.csv:1)

Removed as temporary research scaffolding:

- `notebooks/phase2/08_audio_representation_research.ipynb`

Phase 2 now reads as a bounded engineering investigation rather than a half-implemented feature branch.
