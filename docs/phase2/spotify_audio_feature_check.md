...
Phase 2 includes a small diagnostic script at [scripts/phase2/check_spotify_audio_features.py](/home/seans/becode/projects/BTS-Song-Atlas-/scripts/phase2/check_spotify_audio_features.py:1) to verify whether Spotify Web API audio endpoints are accessible for this project.
