"""
Check AcousticBrainz coverage for BTS Song Atlas Phase 2.
...
def main() -> None:
    ...
    parser.add_argument(
        "--input",
        default="data/processed/song_master.parquet",
        help="Path to current song metadata CSV or Parquet.",
    )
    parser.add_argument(
        "--output",
        default="data/processed/phase2/acousticbrainz_coverage.csv",
